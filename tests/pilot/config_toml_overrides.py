...
_CONFIG_TOML = """
pane_order = ["dash-weather", "dash-potd", "dash-calendar"]
...
async def run() -> None:
    ...
    assert app.app_config.pane_order == ["dash-weather", "dash-potd", "dash-calendar"]
    ...
    expected_prefix = ["dash-weather", "dash-potd", "dash-calendar"]
